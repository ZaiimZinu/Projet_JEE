	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getServletPath().equals("/loginAdmin")) {
			try {
				...
				//String email_admin = "abdel.zinu@gmail.com";
				//String mdp_admin = "abdel09";
				System.out.println("Abdel cc :" + email_admin);
				System.out.println("abdel mtps :" + mdp_admin);
				Administrateur loginA= new Administrateur();
				loginA.setEmail_admin(email_admin);
				
				loginA.setMdp_admin(mdp_admin);
				System.out.println("instance loginA :" + loginA);
						...
						if(request.getServletPath().equals("/AddNewheberg")) {
							try {
								...
								if(res==1) {
									...
									request.setAttribute("Name", "existe d�j�");
																																						...
																																						if(request.getServletPath().equals("/deleteClient")){
																																							...
																																							if(request.getServletPath().equals("/listeParticipants")) {
																																								try {
																																									...
																																									if(a==0) {
																																										request.setAttribute("voya", "Liste compl�te");
																																									}
																																									else {
																																																...
																																																if (path.equals("/login.php")) {
																																																	try {
																																																		...
																																																		if(umetier.login(email, mdp)){
																																																			...
																																																			session.setAttribute("Pr�nom", u.getPrenom_client());
		...
		//////////-------------------------------------Register--------------------------------------------------------------------------////		
																																																	...
																																																	{	
																																																		...
																																																		{ 
																																																			...
																																																			System.out.println("la destination est list�e");
																																																			request.setAttribute("duree", vmetier.liste_Voyage());
																																																			System.out.println("la dur�e est list�e");
																																																					...
																																																					if (path.equals("/RechercheParPlusieursMotsCles")) {
																																																						...
																																																						{ 
																																																							...
																																																							{ 
																																																								...
																																																								System.out.println("type est list�");
																																																								...
																																																								{ 
																																																									...
																																																									System.out.println("theme est list�");
																																																									...
																																																									{ 
																																																										...
																																																										if(path.equals("/ProfilClient"))
																																																										{
																																																											...
																																																											if(vmetier.liste_VoyageConfirmer(idclient).isEmpty()==true) {
																																																												request.setAttribute("VoyageRR", "Pas de voyage confirm�");
																																																											}
																																																											else
																																																											{
																																																											...
																																																											System.out.println("profil affich�");
																																																															...
																																																															{ 
																																																																...
																																																																{  
																																																																	...
																																																																	if (vmetier.liste_Voyage_Hebergement(IdHeber).isEmpty()==true) {
																																																																		...
																																																																		System.out.println("hebergement est list�");
																																																																	}
																																																																	...
																																																																	{ 
																																																																		...
																																																																		case "couple":
																																																																			request.setAttribute("Remarque", "*Vous Pouvez emmener un bin�me");
																																																																			break;
																																																																		case "groupe":
