...
public class LoginAdminDao {
	...
	public boolean login(Administrateur a) throws ClassNotFoundException{
		...
		System.out.println("session sans if  ok" +conn);
        ...
        try {
            ...
            //PreparedStatement preparedStatement = conn.prepareStatement("select * from administrateur where email_admin = 'abdel.zinu@gmail.com' and mdp_admin = 'abdel09' "); 
